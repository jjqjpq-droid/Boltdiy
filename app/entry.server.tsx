...
// On Vercel's Node runtime `react-dom/server` resolves to `server.node`, which
// only exposes `renderToPipeableStream` (no `renderToReadableStream`). The
// Web-Streams `renderToReadableStream` lives in `server.browser`, which works
// on Node because Node provides the Web Streams API. Import it from there.
